// Generated by Qleany v1.11.0 from common_da_use_cases_traits.tera
...
pub trait WriteRelUoW<RF>: CommandUnitOfWork {
    /// Read the current relationship list (used by undoable set/move to capture the
    /// pre-image for a scoped, surgical inverse).
    fn get_relationship(&self, id: &EntityId, field: &RF) -> Result<Vec<EntityId>>;

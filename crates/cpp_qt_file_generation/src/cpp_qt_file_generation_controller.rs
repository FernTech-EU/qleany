...
pub fn generate_cpp_qt_code(
    ...
    let uow_context = GenerateCppQtCodeUnitOfWorkFactory::new(db_context, event_hub);
...
pub fn generate_cpp_qt_files(
    ...
    let uow_context = GenerateCppQtFilesUnitOfWorkFactory::new(db_context, event_hub);
...
pub fn generate_cpp_qt_prompt(
    ...
    let uow_context = GenerateCppQtPromptUnitOfWorkFactory::new(db_context, event_hub);
